...
function useCollection(collectionName, constraints) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useCollection.useEffect": ()=>{
            ...
            setIsLoading(true);
            try {
                const colRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(db, collectionName);
                const safeConstraints = constraints || [];
                const q = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])(colRef, ...safeConstraints);
                const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(q, {
                    "useCollection.useEffect.unsubscribe": (snapshot)=>{
                        const results = [];
                        snapshot.forEach({
                            "useCollection.useEffect.unsubscribe": (doc)=>{
                                results.push({
                                    ...doc.data(),
                                    id: doc.id
                                });
                    ...
                    "useCollection.useEffect.unsubscribe": (err)=>{
                        console.error("Firestore error on collection '".concat(collectionName, "':"), err);
...
_s(useCollection, "tWhIgsOZ7s9FALS8s3FHvz7fU20=", false, function() {
    return [
...
function initiateEmailSignUp(authInstance, email, password) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createUserWithEmailAndPassword"])(authInstance, email, password);
// Code continues immediately. Auth state change is handled by onAuthStateChanged listener.
}
function initiateEmailSignIn(authInstance, email, password) {
    // CRITICAL: Call signInWithEmailAndPassword directly. Do NOT use 'await signInWithEmailAndPassword(...)'.
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signInWithEmailAndPassword"])(authInstance, email, password);
// Code continues immediately. Auth state change is handled by onAuthStateChanged listener.
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
"[project]/src/hooks/useUserProfile.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useUserProfile() {
    _s();
    const { user, isUserLoading: isAuthLoading, userError: authError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"])();
    ...
    const userDocRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemoFirebase"])({
        "useUserProfile.useMemoFirebase[userDocRef]": ()=>user ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, 'users', user.uid) : null
    }["useUserProfile.useMemoFirebase[userDocRef]"], [
        firestore,
        user
    ]);
    const { data: profile, isLoading: isProfileLoading, error: profileError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firestore$2f$use$2d$doc$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDoc"])(userDocRef);
    return {
        user,
        profile,
        isLoading: isAuthLoading || isProfileLoading,
        error: authError || profileError,
        isPro: (profile === null || profile === void 0 ? void 0 : profile.role) === 'pro'
    };
}
_s(useUserProfile, "lYivLutXJ5tOS1jQ6batKc27vP8=", false, function() {
    return [
...
function initializeFirebase() {
    ...
    try {
        ...
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["firebaseConfig"].apiKey) {
...
function ThemeProvider(param) {
    let { children } = param;
    _s();
    const [theme, setThemeState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('light'); // Default to light
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
...
"[project]/src/components/providers/language-provider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LanguageProvider(param) {
    let { children } = param;
    _s();
    const [locale, setLocaleState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('es');
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "LanguageProvider.useCallback[t]": (key, params)=>{
            var _translations_locale;
            let translation = ((_translations_locale = translations[locale]) === null || _translations_locale === void 0 ? void 0 : _translations_locale[key]) || key;
            if (params) {
                Object.keys(params).forEach({
                    "LanguageProvider.useCallback[t]": (paramKey)=>{
                        translation = translation.replace("{".concat(paramKey, "}"), String(params[paramKey]));
                    }
...
_s(LanguageProvider, "orZci2F1xV1hws3J5dSHPBmzrL4=");
_c = LanguageProvider;
...
//# sourceMappingURL=src_0de08121._.js.map