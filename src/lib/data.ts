...
export const libraryItems: LibraryItem[] = [
  ...
  { id: 'lib3', title: 'Deja de ser tú', author: 'Joe Dispenza', category: 'Reflexión', type: 'Texto', imageId: 'library_3', pdfUrl: 'https://drive.google.com/file/d/1NozvPxM_yUNXOPhAId8VQfMkUgaTPbk-/preview', isPremium: true },
  ...
  { id: 'lib5', title: 'Inteligencia Emocional', author: 'Daniel Goleman', category: 'Reflexión', type: 'Texto', imageId: 'library_5', pdfUrl: 'https://drive.google.com/file/d/1KSbPIY568mkmyk38KnqSTKS75h5RSy0l/preview', isPremium: true },
  { id: 'lib6', title: 'Las 48 leyes del poder', author: 'Robert Greene', category: 'Reflexión', type: 'Texto', imageId: 'library_6', pdfUrl: 'https://drive.google.com/file/d/1kJAkcNGzcYFefCyOXH0IgnHkxH7RUjER/preview', isPremium: true },
  ...
  { id: 'lib13', title: 'Poder sin límites', author: 'Tony Robbins', category: 'Energía', type: 'Texto', imageId: 'library_13', pdfUrl: 'https://drive.google.com/file/d/1CYLcYq7yvCnA5zpBBQEKXO7RwBKIczV6/preview', isPremium: true },
